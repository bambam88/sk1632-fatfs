...
#define CS_SETOUT()             _CS_SETOUT() 
#define CS_LOW()                _CS_LOW() 
#define CS_HIGH()               _CS_HIGH()
//Change the SPI port number as needed on the following 5 lines
#define SPIBRG                  _SPIBRG
#define SPIBUF                  _SPIBUF
#define SPISTATbits             _SPISTATbits
#define SPI_CHANNEL             _SPI_CHANNEL
#define SPICONbits              _SPICONbits

#define SPIxFPB               _SPIxFPB      // Peripheral Bus frequency for SPI.      
#define SPIxMAX_FREQ          _SPIxMAX_FREQ // Maximum SPI clock speed.    
#define SPIxMIN_FREQ          _SPIxMIN_FREQ // Minimum SPI clock speed.
...
#define SOCKPORT	_SOCKPORT		/* Socket contact port */
...
#define	FCLK_SLOW()	_FCLK_SLOW()        /* Set slow clock (100k-400k) */
#define	FCLK_FAST()	_FCLK_FAST() 		/* Set fast clock (depends on the CSD) */
